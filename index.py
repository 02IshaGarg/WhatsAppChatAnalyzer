...
if uploaded_file is None:
    st.text('''Please export your WhatsApp chat, whether it be a group chat or an individual/ \n
    private chat, and upload it to this platform. \nAfterward, kindly proceed to click on the \n
    "Analyse" button. This action will generate a variety of insights concerning your conversation. \n
    You will have the option to select the type of analysis, whether it is an overall analysis or \n
    one that specifically focuses on particular participants' analysis.\n\n Thank You\n- Isha Garg''')
